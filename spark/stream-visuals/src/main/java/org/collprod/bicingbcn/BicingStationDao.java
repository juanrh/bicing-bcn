...
/**
 * <p>Quick and dirty pseudo DAO for bicing data, lots of things can be improved, but the idea is:
 * 	<ul>  
 * 	 <li> parse() is the only method of the implied interface </li>
 *   <li> BicingStationDao.Value is the model/value class </li>
 *   <li> this class also implements the contract imposed by parse </li>
 *  </ul>
 * <p>
 * 
 * <p>
...
public class BicingStationDao implements Serializable {
	...
	/**
	 * Generate a iterable of Value objects each of them containing the state of an station, by parsing
	 * the contents of a Bicing XML file
	 * 
	 * <p> Default values:
	 * 	<ul>
	 * 		<li> If streetNumber is absent (i.e. tag <streetNumber></streetNumber>) then -1 is used for this field</li>
	 * 		<li>If height is absent then 0 is used as default</li>
	 * </ul>
	 * </p>
	 * 
	 * <p>
	 ...
	 * </p>
	 * 
	 * 	 @param bicingFileContents Contents of a Bicing XML file that will be parsed
	 *  @return iterable of Value objects for the station data found. The timestamp of the file
	 *  is added to each of these values 
	 * */
